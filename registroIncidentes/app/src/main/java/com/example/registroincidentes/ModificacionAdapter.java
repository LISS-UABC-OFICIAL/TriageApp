...
public class ModificacionAdapter extends RecyclerView.Adapter<ModificacionAdapter.ModificacionViewHolder> implements View.OnClickListener{
    ...
    public void onBindViewHolder(ModificacionViewHolder holder, final int position) {
        ...
        holder.txtNoPaciente.setText(listaHeridos.get(position).getIdPatient().toString());
        holder.txtColor.setText("Color: " + String.valueOf(listaHeridos.get(position).getColor().toString()));
        holder.txtEstado.setText("Estado: " + String.valueOf(listaHeridos.get(position).getState().toString()));
        holder.txtUsuario.setText("Usuario: " + String.valueOf(listaHeridos.get(position).getRegUser().toString()));
        holder.txtFecha.setText(String.valueOf(listaHeridos.get(position).getRegDate().toString()));
